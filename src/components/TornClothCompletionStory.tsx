  ...
  const sequence = useMemo<StorySequence>(() => ({
    ...
    scenes: [{
      ...
      steps: [
        ...
        dialogue("luna-line-2", "luna", "루나", "음?\n그건..?"),
        dialogue("luna-line-3", "luna", "루나", "옷에 쓰이는 천 조각이잖아!\n\n그런데\n이건 좀 이상한걸.."),
        hide("hide-luna-1", "luna"),
        show("show-theo-1", "theo", "default"),
        dialogue("theo-line-1", "theo", "테오", "던전 2층은\n\n분명 고구려,\n백제,\n신라로 대표되는\n\n삼국시대였죠."),
        dialogue("theo-line-2", "theo", "테오", "그런데\n\n이건...\n\n삼국시대의 천이 아닌 것 같습니다."),
        hide("hide-theo-1", "theo"),
        show("show-luna-2", "luna", "happy"),
        dialogue("luna-line-4", "luna", "루나", "그렇다는 건...\n\n어쩌면\n\n이 시대와 전혀 맞지 않은 사람이\n\n이 던전을 먼저 지나쳐갔다는 뜻이겠네."),
        hide("hide-luna-2", "luna"),
        show("show-theo-2", "theo", "default"),
        dialogue("theo-line-3", "theo", "테오", "확실하지는 않으니\n\n우선 조사를 계속하는 것이\n좋아 보입니다."),
        hide("hide-theo-2", "theo"),
        show("show-luna-3", "luna", "happy"),
        dialogue("luna-line-5", "luna", "루나", `알겠어.\n\n${playerName || "플레이어"},\n\n앞으로도\n계속 조사 부탁해!`),
      ],
    }],
  }), [playerName]);
